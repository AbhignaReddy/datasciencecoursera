...
#Merging the test set with Activity and subject columns
...
#Merging the Activity and subject columns with train set
...
#Subset the data for mean and std columns
